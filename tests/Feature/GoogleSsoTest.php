...
test('callback logs in an existing user and links their google id', function () {
...
test('callback does not overwrite existing email_verified_at', function () {
...
test('callback rejects emails from non-allowed domains', function () {
...
test('callback allows emails from allowed domains', function () {
    config(['services.google.allowed_domains' => ['allowed.com']]);
...
test('callback allows all domains when allowed_domains is empty', function () {
...
test('login page shows sso button when google credentials are configured', function () {
    config([
...
test('login page shows traditional form when google credentials are not configured', function () {
    config([
...
test('register route redirects to google when sso is enabled', function () {
    config([
        'services.google.client_id' => 'test-client-id',
        'services.google.client_secret' => 'test-secret',
    ]);
...
test('forgot password route redirects to google when sso is enabled', function () {
    config([
        'services.google.client_id' => 'test-client-id',
        'services.google.client_secret' => 'test-secret',
    ]);
...
test('authenticated users cannot access google sso routes', function () {
